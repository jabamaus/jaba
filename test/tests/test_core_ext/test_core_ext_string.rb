module JABA
  ...
  class TestCoreExtString < JabaTest
    ...
    it 'supports relative_path_from' do
      ...
      # Test with paths containing macros
      '$(SolutionDir)/a/b'.relative_path_from('c/d').must_equal('$(SolutionDir)/a/b')
      '$(SolutionDir)/a/../b'.relative_path_from('c/d').must_equal('$(SolutionDir)/b')
      '$(SolutionDir)/a/../b'.relative_path_from('C:/c/d').must_equal('$(SolutionDir)/b')
