jtest 'supports creating new node types' do
...
jtest 'supports opening types and instances' do
  #assert_jaba_error "Error at #{src_loc('E3E0E4DB')}: Cannot open undefined type ':undefined'." do
  #  jaba(barebones: true) do
  #    open_type :undefined do # E3E0E4DB
  #    end
  #  end
  #end
  # TODO: reinstate
=begin
  assert_jaba_error "Error at #{src_loc('37E49061')}: Cannot open undefined instance ':undefined_id'." do
    jaba(barebones: true) do
      open_instance 'undefined_type|undefined_id' do # 37E49061
      end
    end
  end
  assert_jaba_error "Error at #{src_loc('826F5090')}: Cannot open instance of undefined type ':undefined_id'." do
    jaba(barebones: true) do
      open_instance 'undefined_type|undefined_id' do # 826F5090
      end
    end
  end
=end
...
jtest 'supports defining new attribute types' do
  # TODO
end

jtest 'supports defining new attribute flags' do
  # TODO
end

jtest 'supports a generate hook per-definition' do
...
jtest 'supports defining an inline type plugin' do
...
jtest 'can build a tree of nodes' do
