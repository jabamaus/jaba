...
=end
  a_uuid = "{2C523333-1040-53D0-85DB-F34725B6A1D4}"
  b_uuid = "{628621CE-7752-5EB0-8DA2-0BAE98D71AF3}"
  c_uuid = "{F2EE4069-5F03-59DB-8194-1D3490562C7F}"
  d_uuid = "{CFB67C49-DB25-5F50-B911-3726D89CC057}"
